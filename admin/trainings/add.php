...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $slug = CPAFunctions::createSlug($title);
    ...
    $existing = $db->fetchOne("SELECT id FROM trainings WHERE slug = ?", [$slug]);
    if ($existing) {
        $slug = $slug . '-' . time();
    }
    ...
    if (empty($errors)) {
        try {
            ...
            $trainingId = $db->insert('trainings', $trainingData);
...
<?php include '../../admin/includes/admin_sidebar.php'; ?>
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Add New Training</h1>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-graduation-cap me-2"></i> Training Details</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">This will be displayed as the main title of the training.</div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              rows="3" 
                                              required><?php echo isset($_POST['short_description']) ? htmlspecialchars($_POST['short_description']) : ''; ?></textarea>
                                    <div class="form-text">Brief summary (150-200 characters) shown in listings.</div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              rows="6"><?php echo isset($_POST['full_description']) ? htmlspecialchars($_POST['full_description']) : ''; ?></textarea>
                                    <div class="form-text">Detailed description of the training program.</div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="course_type" name="course_type">
                                                <option value="echocardiography" <?php echo (isset($_POST['course_type']) && $_POST['course_type'] == 'echocardiography') ? 'selected' : ''; ?>>Echocardiography Training</option>
                                                <option value="ecg_masterclass" <?php echo (isset($_POST['course_type']) && $_POST['course_type'] == 'ecg_masterclass') ? 'selected' : ''; ?>>ECG Interpretation Masterclass</option>
                                                <option value="other" <?php echo (isset($_POST['course_type']) && $_POST['course_type'] == 'other') ? 'selected' : ''; ?>>Other Course</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="duration" 
                                                   name="duration" 
                                                   placeholder="e.g., 56 days, 4-6 weeks"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="<?php echo isset($_POST['format']) ? htmlspecialchars($_POST['format']) : ''; ?>">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-text">Leave empty for free courses.</div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" 
                                                   ...
                                                   name="featured_image" 
                                                   accept="image/*">
                                            <div class="form-text">Recommended size: 800x450 pixels. Max 2MB.</div>
                                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!title || !shortDesc) {
            e.preventDefault();
            alert('Please fill in all required fields (Title and Short Description).');
            return false;
        }
    });
